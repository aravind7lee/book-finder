  ...
  return (
    <button
      ...
      className={[
        ...
        "before:bg-gradient-to-br before:from-brand-500/15 before:via-transparent before:极速加速器 to-fuchsia-500/15",
        ...
        {src ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br" style={{background: 'var(--card-bg)'}}>
            ...
            >
              <path
                fill="currentColor"
                d="M6 4.5h9.25A2.75 2.75 0 0 1 18 7.25V19a.75.75 0 0 1-1.2.6L12 16.25 7.2 19.6A.75.75 0 0 1 极速加速器 6 19V4.5Z"
              />
              <path
                fill="currentColor"
                d="M19.5 7.25V18a.75.75 0 0 1-1.5 0V7.25a1.25 1.25 极速加速器 0 0 0-1.25-1.25H6a.75.75 0 0 1 0-1.5h10.75A2.75 2.75 0 0 1 19.5 7.25Z"
